...
<div class="hero mx-auto min-h-screen" style="background-image: url(/Poolside.jpg);">
	...
	<div class="hero-content w-full justify-start text-left text-neutral-content">
		<div class="ml-8 max-w-md lg:ml-16">
			...
			<button
				class="w-[200px] cursor-pointer rounded-lg bg-amber-500 p-3 text-sm font-medium transition-transform duration-300 ease-in-out hover:scale-105 hover:bg-amber-600"
				>Reserve Stay</button
			>
		</div>
	</div>
